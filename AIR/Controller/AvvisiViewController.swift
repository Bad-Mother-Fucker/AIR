...
class AvvisiViewController: UIViewController,UITableViewDelegate,UITableViewDataSource {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        tableViewAvvisi.rowHeight = UITableViewAutomaticDimension
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.setCell(perAvviso: Bacheca.avvisi.reversed()[indexPath.row])
